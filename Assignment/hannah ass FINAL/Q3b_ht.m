...
fprintf('Figure 8 shows the recovered gold as a function of sluice feed rate.\n\n')
...
fprintf('Having found the optimal feed rate, this value is then substituted into the\nrecovered_gold function')
